...
class Favicon {
  static Future<List<Icon>> getAll(String body, {List<String>? suffixes}) async {
    var favicons = <Icon>[];
    var iconUrls = <String>[];
  ...
  static Future<Icon?> getBest(String body, {List<String>? suffixes}) async {
    List<Icon> favicons = await getAll(body, suffixes: suffixes);
